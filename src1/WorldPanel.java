...
public class WorldPanel extends JPanel implements KeyListener {
    ...
    private String grassTexturePath = "../GrassTexture/GrassTexture.png";
    private Image grassTexture;

    private String tallGrassImgPath = "../TallGrass/TallGrassTexture.png";
    ...
    private final int IDLE_WAIT = 1000;
    ...
    private void drawHUD(Graphics2D g) {
        ...
        g.drawString("Pokémon: " + pokemonList, 20, 75);
    ...
    private void faceNPCtowardsPlayer(Trainer npc, int lastPlayerCol, int lastPlayerRow) {
        ...
        if (py < ny) npc.setFacingDirection(0);
        else if (py > ny) npc.setFacingDirection(1);
        else if (px > nx) npc.setFacingDirection(2);
        else if (px < nx) npc.setFacingDirection(3);
    }
